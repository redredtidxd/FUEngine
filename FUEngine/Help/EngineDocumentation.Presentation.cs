...
public static partial class EngineDocumentation
{
    ...
    private static readonly Dictionary<string, (string Subtitle, string EnMotor)> ManualPresentation = new(StringComparer.Ordinal)
    {
        ...
        ["compilar-desde-fuente"] = (
            ...
            "publicar.bat genera un FUEngine.exe autocontenido; no confundas con solo clonar y abrir el .exe de un zip viejo. El SDK y la ruta publish son propias de este repo."),
        ["layout-editor"] = (
