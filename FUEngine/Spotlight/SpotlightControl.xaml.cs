...
public partial class SpotlightControl : System.Windows.Controls.UserControl
{
    ...
    private void UpdateIndexTotals()
    {
        ...
        TxtIndexTotals.Text =
            $"Índice: Manual {t.Documentation} · Lua {t.LuaTotal} (resúmenes tablas {t.LuaGlobalGuides} · API {t.LuaReflection} · hooks {t.LuaHooks} · estándar {t.LuaBuiltins} · sintaxis {t.LuaKeywords}) · Hub: {t.HubRecentProjects} proyectos recientes";
    }
