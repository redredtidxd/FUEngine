...
internal static class LuaSpotlightDescriptions
{
    ...
    public static readonly IReadOnlyDictionary<string, (string Detail, string? Example)> MemberHints =
        new Dictionary<string, (string, string?)>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            // --- log ---
            ["log.info"] = ("Mensaje informativo a la consola del editor (Play).", "log.info(\"listo\")"),
            ["log.warn"] = ("Advertencia a la consola.", "log.warn(\"cuidado\")"),
            ["log.error"] = ("Error a la consola.", "log.error(\"fallo\")"),
