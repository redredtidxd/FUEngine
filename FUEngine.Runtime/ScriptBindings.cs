...
public static class ScriptBindings
{
    ...
    public static void SetLog(LuaTable env, LuaLogApi api)
    {
        env["log"] = api;
    }
...
public class GameApi
{
    ...
    {
        var s = LuaTypeCheck.ToInt32(seed, "seed");
        _rng = new Random(s);
    }

    public int randomInt(object? minInclusive, object? maxExclusive)
    {
        var a = LuaTypeCheck.ToInt32(minInclusive, "minInclusive");
        var b = LuaTypeCheck.ToInt32(maxExclusive, "maxExclusive");
        return _rng.Next(a, b);
    }
